...
局部变量可以不用声明为final，但是必须不可被后面的代码修改（即隐性的具有final的语义）
...
我们之前将的Formula接口就定义了一个默认方法sqrt,可以从包含匿名对象的每个 formula 实例访问该方法。
...
- jdk1.8中新增了 LocalDate 与 LocalDateTime等类来解决日期处理方法，同时引入了一个新的类DateTimeFormatter 来解决日期格式化问题。可以使用Instant代替 Date，LocalDateTime代替 Calendar，DateTimeFormatter 代替 SimpleDateFormat。
  ...
  System.out.println(millis);//1611212635118
  Instant instant = clock.instant();
  System.out.println(instant);//2021-01-21T07:03:55.118Z
  Date legacyDate = Date.from(instant); 
  System.out.println(legacyDate);//Thu Jan 21 15:03:55 CST 2021
  ```
  ...
  System.out.println(now1); //08:15:07.146
  System.out.println(now2); //05:15:07.151
  ...
  System.out.println("今天的日期: "+today);//2021-01-21
  LocalDate tomorrow = today.plus(1, ChronoUnit.DAYS);
  System.out.println("明天的日期: "+tomorrow);//2021-01-22
  LocalDate yesterday = tomorrow.minusDays(2);
  System.out.println("昨天的日期: "+yesterday);//2021-01-20
  LocalDate independenceDay = LocalDate.of(2021, Month.JANUARY, 21);
  DayOfWeek dayOfWeek = independenceDay.getDayOfWeek();
  System.out.println("今天是周几:"+dayOfWeek);//THURSDAY
  ```
  ...
  System.out.println(date);//2021-01-21T15:27:13.261
  DateTimeFormatter formatter=DateTimeFormatter.ofPattern("YYYY-MM-dd HH:mm:ss");
  System.out.println(formatter.format(rightNow));//2021-01-21 15:27:13
  ```
